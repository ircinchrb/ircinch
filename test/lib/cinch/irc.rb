...
class IRCTest < TestCase
  ...
  test "connect uses ssl if configured" do
    ...
    def mock_ssl_context.verify_mode=(v)
    end

    def mock_ssl_context.ca_path=(v)
    end
