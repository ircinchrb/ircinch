...
class UserTest < TestCase
  ...
  class MockUserList
    def find_ensured(name); end
    def update_nick(user); end
  end
  ...
  test "online= dispatches events" do
    ...
    def handlers.dispatch(event, *args); @dispatched ||= []; @dispatched << event; end
    def handlers.dispatched; @dispatched; end
